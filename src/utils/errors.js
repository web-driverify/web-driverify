...
class UnknownCommand extends WDError {
  constructor (msg) {
    ...
    this.status = 9
    this.message = msg || 'The requested resource could not be found, or a request was received using an HTTP method that is not supported by the mapped resource.'
  }
}
